...
public class RoomServiceImpl implements RoomService{
	...
	//@Transactional
	@Override
	public Mono<RoomResponse> create(RoomCreateRequest request, String ownerId) {
	...
	@Override
	  public Mono<RoomResponse> getById(final String id, String ownerId) {
	      return repository.findById(id)
	              .switchIfEmpty(Mono.error(new RoomNotFoundException(id)))
//	              .map(mapper::toResponse)
	...
	@Override
	  public Mono<PageDTO<RoomResponse>> getRoomByFilterPagination(final RoomFilterDTO filterDTO, String ownerId) {
	      ...
	      // get from context from the database 	      
