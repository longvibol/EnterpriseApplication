...
export class RoomDetailComponent {
  ...
  private route = inject(ActivatedRoute); // get from the url 
  private router = inject(Router); // redirect to other route 
  ...
  hasAmenity = (r: Room | null, k: AmenityKey): boolean => !!(r && r[k]); // specific the selection and change color to green
